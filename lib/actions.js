...
(function () {
  ...
  function init(deps) {
    ...
    function setCopyBatchEnabled(enabled) {
      ...
      if (copyBatchCsvBtnEl) copyBatchCsvBtnEl.disabled = disabled;
      if (copyBatchJsonBtnEl) copyBatchJsonBtnEl.disabled = disabled;
      if (copyBatchUrlsBtnEl) copyBatchUrlsBtnEl.disabled = disabled;

      // Old UI remnants (safe no-ops if they still exist somewhere)
      if (copyBatchBtnEl) copyBatchBtnEl.disabled = disabled;
      if (copyBatchSelectEl) copyBatchSelectEl.disabled = disabled;
    }
