  ...
  function init(deps) {
    ...
    function refreshBatchCopyEnabled() {
      try {
        ...
        // Copy buttons require deduped URLs
        setCopyBatchEnabled(hasDeduped);

        // Open first requires at least one valid URL
        setOpenFirstEnabled(hasValid);

        // Downloads require valid URLs
        setBatchDownloadEnabled(hasValid);
      } catch {
