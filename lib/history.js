...
(function () {
  ...
  function render() {
    ...
    for (const item of items) {
      ...
      if (isSingle) {
        actionsHtml =
          btnHtml({ act: "copy", label: "Copy URL", icon: "copy" }) +
          btnHtml({ act: "open", label: "Open", icon: "open" }) +
          btnHtml({ act: "download", label: "Download", icon: "download" }) +
          btnHtml({ act: "load", label: "Restore", icon: "restore" }) +
          btnHtml({ act: "remove", label: "Remove", icon: "remove", classes: "secondary small danger" });
        ...
        actionsHtml =
          btnHtml({ act: "restore", label: "Restore", icon: "restore" }) +
          btnHtml({ act: dlAct, label: dlLabel, icon: "download" }) +
          btnHtml({ act: "copyUrls", label: "Copy URL list", icon: "copy" }) +
          btnHtml({ act: "remove", label: "Remove", icon: "remove" });

      } else if (isCopyEvent) {
        actionsHtml =
          btnHtml({ act: "copyText", label: "Copy", icon: "copy" }) +
          btnHtml({ act: "remove", label: "Remove", icon: "remove" });

      } else {
        actionsHtml = btnHtml({ act: "remove", label: "Remove", icon: "remove" });
      }
  ...
  function iconSvg(name) {
    const map = {
      ...
      download: "i-download",
      remove: "i-clear",
      restore: "i-open", // reuse open icon unless you later add a dedicated restore icon
    };
